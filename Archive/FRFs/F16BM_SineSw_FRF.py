...
freqs, H1L1_mag, _ = compute_frf(RdataSineSw_L1, input_key='Force', output_key='Acceleration1')
freqs, H2L1_mag, _ = compute_frf(RdataSineSw_L1, input_key='Force', output_key='Acceleration2')
freqs, H3L1_mag, _ = compute_frf(RdataSineSw_L1, input_key='Force', output_key='Acceleration3')

# Compute FRFs for Level 5
freqs, H1L5_mag, _ = compute_frf(RdataSineSw_L5, input_key='Force', output_key='Acceleration1')
freqs, H2L5_mag, _ = compute_frf(RdataSineSw_L5, input_key='Force', output_key='Acceleration2')
freqs, H3L5_mag, _ = compute_frf(RdataSineSw_L5, input_key='Force', output_key='Acceleration3')

# Compute FRFs for Level 7
freqs, H1L7_mag, _ = compute_frf(RdataSineSw_L7, input_key='Force', output_key='Acceleration1')
freqs, H2L7_mag, _ = compute_frf(RdataSineSw_L7, input_key='Force', output_key='Acceleration2')
freqs, H3L7_mag, _ = compute_frf(RdataSineSw_L7, input_key='Force', output_key='Acceleration3')
